...
public class WETextureRegion{
	 ...
	 * @param texture
	 */
	public WETextureRegion(Texture texture) {
		if (texture == null) {
	 ...
	 * sprite when drawn.
	 * @param height The height of the texture region. May be negative to flip
	 * the sprite when drawn.
	 */
	public WETextureRegion(Texture texture, int width, int height) {
		this.texture = texture;
	 ...
	 * the sprite when drawn.
	 */
	public WETextureRegion(Texture texture, int x, int y, int width, int height) {
		this.texture = texture;
	 ...
	 * @param v2
	 */
	public WETextureRegion(Texture texture, float u, float v, float u2, float v2) {
		this.texture = texture;
		setRegion(u, v, u2, v2);
	}
	 ...
	 * @param region
	 */
	public WETextureRegion(WETextureRegion region) {
		setRegion(region);
	}
	...
	WETextureRegion(TextureRegion region) {
		setRegion(region);
	}
	 ...
	 * @param region
	 */
	public void setRegion(WETextureRegion region) {
	 ...
	 * @param yAmount The percentage to offset vertically. This is done in
	 * texture space, so up is negative.
	 */
